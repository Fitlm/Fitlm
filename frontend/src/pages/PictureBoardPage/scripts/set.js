document.getElementById('uproad').addEventListener('click', function() {
    ...
    Array.from(files).forEach((file, index, array) => {
        if (!file.type.startsWith('image/')) { 
            ...
            if (loadedFiles === files.length) {
                console.log(startY); // 모든 파일이 로드된 후 startY 출력
            }
            return; 
        }
        ...
        reader.onload = function(e) {
            ...
            imgElement.onload = function() {
                ...
                memoButton.style.width = '15px';
                memoButton.style.height = '16px';
                memoButton.style.right = '1%';
                ...
                flipIconBack.style.marginTop = '2px';
                ...
                tapeImage.style.height = '53px';
                tapeImage.style.top = '-27px';
                tapeImage.style.left = '50%';
                const randomRotate = Math.random() * 26 - 13;
                ...
                if (loadedFiles === files.length) {
                    ...
                    bottomElement.style.top = `${startY + 325}px`;
